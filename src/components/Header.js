  ...
  return (
    <header>
      <nav className="bg-gray-900 flex justify-around items-center flex-wrap p-4">
        <div>
          <img className='max-h-20 animate-bounce' src={logo} alt="Coodesh logo" />
        </div>
        <div>
          <h1 className="font-semibold  text-3xl text-center text-white tracking-tight">Covid Daily Cases</h1>
        </div>
        <div>
